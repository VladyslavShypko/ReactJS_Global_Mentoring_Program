            ...
            <div className='movie-form' id='movie-form'>
                ...
                {!deleteMovieModalOpen ? (
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        {formik.touched.release_date && formik.errors.release_date && <p className='error'>{formik.errors.release_date}</p>}
                        ...
                        {formik.touched.poster_path && formik.errors.poster_path && <p className='error'>{formik.errors.poster_path}</p>}
                        ...
                        {formik.touched.overview && formik.errors.overview && <p className='error'>{formik.errors.overview}</p>}
                        ...
                        {formik.touched.runtime && formik.errors.runtime && <p className='error'>{formik.errors.runtime}</p>}
